  ...
  try
    try
      ...
      if ParamCount <> 1 then
        raise Exception.Create('CertGenerator.exe "<output_certificate_fullpath>');
      ///

      OpenSSL_GenerateSelfSignedCertificate(ParamStr(1));
