...
type
  TS7MessageBox = class(TComponent)
  private
    {@M}
  public
    {@M}
...
uses S7MessageBoxForm, S7InputQueryForm, System.SysUtils;

{-------------------------------------------------------------------------------
  Spawn MessageBox
-------------------------------------------------------------------------------}
function TS7MessageBox.MessageBox(AOwner : TForm; const AMessage, ATitle : String; const AFlags : Integer = 0) : Integer;
...
{-------------------------------------------------------------------------------
  Spawn InputQuery
-------------------------------------------------------------------------------}
function TS7MessageBox.InputQuery(AOwner : TForm; const ADescription, ATitle : String) : String;
